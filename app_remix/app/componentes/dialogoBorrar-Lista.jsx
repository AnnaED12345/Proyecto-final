        ...
        {modalBorrarLista && (
          <div className='fixed z-50 inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center' >
            ...
            <div className='flex items-center justify-center mb-5'>
              ...
              <p className="text-MidnightBlue text-lg font-bold text-center">¿Estás seguro de que deseas borrar la lista?</p>
                <p className="text-MidnightBlue text-center text-md font-light">Atención: Se borrarán todas las tareas vinculadas a esta lista</p>
