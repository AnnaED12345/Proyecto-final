...
export default function DialogoEditarLista({usuarioId, idList, cargarListas, modalEditarLista, setModalEditarLista}) {
    ...
    const onSubmitLista = (event) => { //Acepta la edición de la lista y cierra la ventana modal
    ...
    const onCancelarEditarLista = () => { //Cancela la edición de la lista y cierra la ventana modal
      setModalEditarLista(false);
    }  
